...
const onlinePresenceList = [
  {
    embed: "https://www.youtube.com/embed/aX8Ol8AGbXY",
    title: "Short-form Ad",
    metric: "Scripted, shot, edited",
    tag: ["YouTube Shorts", "Shoot", "Edit"],
    link: "https://youtube.com/shorts/aX8Ol8AGbXY?feature=share",
    format: "reel",
  },
  {
    embed: "https://www.youtube.com/embed/qK86cL8W5MM",
    title: "Creative Reel",
    metric: "Performance format",
    tag: ["YouTube Shorts", "Creative", "Edit"],
    link: "https://youtube.com/shorts/qK86cL8W5MM?si=IkRsZI5iF7xW9P1r",
    format: "reel",
  },
  {
    embed: "https://www.youtube.com/embed/J589uLMiUCU",
    title: "Product Short",
    metric: "Campaign-ready edit",
    tag: ["YouTube Shorts", "Product", "UGC Style"],
    link: "https://youtube.com/shorts/J589uLMiUCU?si=CX7mBAfZvR2UZqE_",
    format: "reel",
  },
  {
    embed: "https://www.youtube.com/embed/tbKg3O7YzGQ",
    title: "Campaign Video",
    metric: "Concept to delivery",
    tag: ["YouTube", "Production", "Editing"],
    link: "https://youtu.be/tbKg3O7YzGQ?si=bp9U8hfnGbVSUzVc",
    format: "reel",
  },
  {
    embed: "https://www.youtube.com/embed/dHVXOudSZaI",
    title: "Long-form Edit",
    metric: "Production showcase",
    tag: ["YouTube", "Shoot", "Edit"],
    link: "https://youtu.be/dHVXOudSZaI?si=YXrixGRyVDyd_oJ_",
    wide: true,
    format: "wide",
  },
  {
    embed: "https://www.youtube.com/embed/WypD303YoXw",
    title: "Brand Video",
    metric: "Campaign asset",
    tag: ["YouTube", "Creative", "Delivery"],
    link: "https://www.youtube.com/watch?v=WypD303YoXw",
    wide: true,
    format: "wide",
  },
  {
    embed: "https://www.youtube.com/embed/ZFB56oMVnfs",
    title: "Production Work",
    metric: "Final video",
    tag: ["YouTube", "Editing", "Campaign"],
    link: "https://youtu.be/ZFB56oMVnfs?si=DkrSgkuRqkg2vfLB",
    wide: true,
    format: "wide",
  },
];

const designInsightList = [
  {
    title: "Design creatives with strong insights",
    description:
      "Created static advertisements, promotional creatives, packaging concepts, and campaign assets using Canva, aligned with performance goals like CTR, ROAS, and conversions.",
    stats: ["Static ads", "Packaging concepts", "Promotional creatives", "Insight-led variants"],
  },
];
