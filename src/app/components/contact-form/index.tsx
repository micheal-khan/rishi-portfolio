...
function ContactForm() {
  ...
  const reset = () => {
    formData.name = ''
    formData.email = ''
    formData.interest = 'performance creative'
    formData.budget = ''
    formData.message = ''
  }
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch('https://formsubmit.co/ajax/rishimotwani295@gmail.com', {
      method: 'POST',
          ...
          <div className='flex flex-col gap-10 md:gap-20'>
            <div className='relative flex flex-col text-center items-center'>
              <h2 className='font-medium w-full max-w-32'>
                <TextGenerateEffect words="Hire Rishi or discuss a" duration={0.5}  />
                <TextGenerateEffect
              ...
              <form
                ...
                <div className='flex flex-col md:flex md:flex-row gap-6'>
                  <div className='w-full'>
                    ...
                    <select
                      ...
                      <option value='shoot and edit'>Shoot and Edit</option>
                      <option value='creative production role'>Creative Production Role</option>
                    </select>
                  </div>
                  <div className='w-full'>
                    <label htmlFor='budget'>Timeline</label>
                    <select
                      ...
                      <option value='urgent'>Urgent campaign</option>
                ...
                <div className='w-full'>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder='Share the campaign, role, deliverables, or reference links'
                    rows={4}
                  />
                </div>
                <div>
