        ...
        <div className='container relative z-10'>
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <div
              ...
              <h1>
                <TextGenerateEffect words="Rishi Motwani crafts" />
                <TextGenerateEffect
                  words="performance ads"
                  delay={0.8}
                  className="italic font-normal instrument-font"
                />
              </h1>
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Creative Production Lead from Jaipur with 2+ years building
                Meta and Google campaign creatives from concept, script, shoot,
                edit, and final delivery.
              </p>
            </div>
