            ...
            <motion.div
              ...
              <div className='flex flex-col gap-3 items-center text-center'>
                <h2 className='text-3xl md:text-5xl dark:text-dark_black'>
                  <TextGenerateEffect words="Ready to build creatives" />
                  <TextGenerateEffect
                    words="that perform?"
                    delay={1}
                ...
                <p className='dark:text-dark_black'>
                  For campaign shoots, performance ad variants, content
                  production, or a creative production role, reach out directly.
                </p>
              </div>
              <Link
                href='/contact'
